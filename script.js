...
/* Centramos el título y colocamos los marcadores a la derecha */
.barra-superior{
...
/* ================= AUDIO ================= */
#audio-container{
  margin:1em auto 2.5em; /* más aire por la barra fija */
...
/* =========================================================
   ...
   ========================================================= */
#leyenda{
  display:flex;flex-direction:column;align-items:stretch;gap:.6em;
  max-width:700px;width:100%;margin:1.5em auto;text-align:left;
}
...
/* =========================================================
   PISTA
   ========================================================= */
#pista-wrap{display:flex;flex-direction:column;align-items:center;gap:.8em;margin-top:1em;}
#btnPista{padding:.6em 1.2em;font-size:1em;font-weight:600;}
#pistaBox{
  max-width:700px;padding:.8em 1.2em;border-radius:8px;background:rgba(255,255,255,.85);
  font-size:.95rem;line-height:1.5;color:#222;text-align:left;box-shadow:0 2px 6px rgba(0,0,0,.15);
}
